...
class BestbuyClient(object):
    ...
    def __init__(self, apikey,
        ...
        """
        self.url = "http://api.bestbuy.com/v1"
        self.apikey = apikey
        self.page_size = 100
...
&pageSize=%(page_size)s&page=%(page)s&apiKey=%(apikey)s' % {
    ...
    def _request(self, url):
        """Bare urllib Request. No much handling, will just catch
    ...
    def newSearch(self, query):
        ...
        url = "https://www.bestbuy.ca/api/v2/json/search?query=" + query
        r = self._request(url)
        robject = json.loads(r)
        return robject["products"]
